...
export const metadata: Metadata = {
  ...
  keywords: [
    "demo games", "игры без регистрации", "игры онлайн бесплатно", "браузерные игры",
    "играть бесплатно", "games", "online games", "demo", "games without registration", "free games"
  ],
  ...
  openGraph: {
    ...
    siteName: "Demo Games",
    images: [{ url: "https://demogames-sigma.vercel.app/", width: 512, height: 512 }],
    type: "website",
  },
  twitter: {
